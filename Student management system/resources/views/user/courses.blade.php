...
@section('content')
    {{-- <h1>My courses</h1> --}}
    <!-- Navbar Start -->
    <div class="jumbotron jumbotron-fluid" style="margin-bottom: 90px; color : rgb(35, 136, 150);">
        <div class="container text-center my-5 py-5">
            <h1 class="text-black mt-4 mb-4">Learn From Home</h1>
            <h1 class="text-black display-1 mb-5">Education Courses</h1>
                ...
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="bg-white p-5">
                            ...
                            <img class="img-fluid mr-4" src="{{ URL::asset('images/testimonial-2.jpg') }}" alt="">
            ...
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{ URL::asset('images/feature.jpg') }}"
