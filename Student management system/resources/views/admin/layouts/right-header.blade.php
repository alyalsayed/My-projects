                ...
                <div class="dropdown-menu" aria-labelledby="message">
                    ...
                    <a class="dropdown-item media" href="#">
                        <span class="photo media-left"><img alt="avatar"
                                src="{{ URL::asset('images/avatar/1.jpg') }}"></span>
                    ...
                    <a class="dropdown-item media" href="#">
                        <span class="photo media-left"><img alt="avatar"
                                src="{{ URL::asset('images/avatar/2.jpg') }}"></span>
                        <div class="message media-body">
                    ...
                    <a class="dropdown-item media" href="#">
                        <span class="photo media-left"><img alt="avatar"
                                src="{{ URL::asset('images/avatar/3.jpg') }}"></span>
                        <div class="message media-body">
                    ...
                    <a class="dropdown-item media" href="#">
                        <span class="photo media-left"><img alt="avatar"
                                src="{{ URL::asset('images/avatar/4.jpg') }}"></span>
                        <div class="message media-body">
